...
<body>
    ...
    <div class="inscription">
        <form method="get" id="inscription" action="inscription.php">
            ...
            <input type="date" id="date" name="bDate" class="meme" min="1900-01-01" max="2500-01-01"><br><br>
            
            <label>Status :</label><br>                
                
                <label for="celib">Célibataire <input type="radio" name="Status" id="celib" value="Celibataire"></label><br>              
                
                <label for="couple">En couple <input type="radio" name="Status" id="couple" value="En Couple"></label><br>               
